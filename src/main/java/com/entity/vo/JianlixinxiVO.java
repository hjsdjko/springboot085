...
public class JianlixinxiVO  implements Serializable {
	...
	public void setYingpinjianshu(String yingpinjianshu) {
		this.yingpinjianshu = yingpinjianshu;
	}
	
	/**
	 * 获取：应聘简述
	 */
	public String getYingpinjianshu() {
		return yingpinjianshu;
	}
