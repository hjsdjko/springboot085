...
public class ZhaopinxinxiModel  implements Serializable {
	...
	public void setZhaopinhaibao(String zhaopinhaibao) {
		this.zhaopinhaibao = zhaopinhaibao;
	}
	
	/**
	 * 获取：招聘海报
	 */
	public String getZhaopinhaibao() {
		return zhaopinhaibao;
	}
