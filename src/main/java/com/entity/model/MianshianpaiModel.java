 ...
 */
public class MianshianpaiModel  implements Serializable {
	...
	public void setMianshidizhi(String mianshidizhi) {
		this.mianshidizhi = mianshidizhi;
	}
	
	/**
	 * 获取：面试地址
	 */
	public String getMianshidizhi() {
		return mianshidizhi;
	}
